...
sap.ui.core.mvc.Controller.extend("sprint.planning.fiori.view.Master", {
	...
	loadDetailView : function(){
		this.getRouter().myNavToWithoutHash({ 
			...
			targetViewName : "sprint.planning.fiori.view.Detail",
			targetViewType : "XML"
		});
	},
	...
	onUpdateFinished: function() {
	    var iCount = this.getView().byId("list").getBinding("items").getLength();
	    var oBundle = this.getView().getModel("i18n").getResourceBundle();
	    var title = oBundle.getText("masterTitle", [iCount]);
	    this.getView().byId("masterPage").setTitle(title);
	},
